...
module Instructions
  def instructions
    <<~HEREDOC
      ...
      If the hidden code is [white, \e[31mred\e[0m, \e[34mblue\e[0m, \e[33myellow\e[0m], you would have to type in 1346 for that selection.

      Each guess made will be provided feedback on it's accuracy. A white circle will indiciate that
      a correct color was guessed in the right location. An empty circle will indicicate that a
      correct color was guessed, but in the wrong location.
